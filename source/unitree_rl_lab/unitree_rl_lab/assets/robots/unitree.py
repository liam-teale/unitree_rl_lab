...
UNITREE_G1_29DOF_CFG = UnitreeArticulationCfg(
    ...
    actuators={
        ...
        "N5020-16-parallel": unitree_actuators.UnitreeActuatorCfg_N5020_16_parallel(
            joint_names_expr=[".*waist_roll_joint", ".*waist_pitch_joint", ".*ankle.*"],
        ),
...
UNITREE_R1_CFG = UnitreeArticulationCfg(
    spawn=UnitreeUrdfFileCfg(
        asset_path=f"{UNITREE_ROS_DIR}/robots/r1_description/R1_lock_head.urdf",
    ),
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(0.0, 0.0, 0.74),
        joint_pos={
            ".*_hip_pitch_joint": -0.23,
    ...
    actuators={
        "N6010B-32": unitree_actuators.UnitreeActuatorCfg_N6010B_32(
            joint_names_expr=[".*_hip_.*", ".*_knee_.*", ".*_shoulder_pitch_.*", ".*_shoulder_roll_.*"],
        ),
        "N6010B-32-parallel": unitree_actuators.UnitreeActuatorCfg_N6010B_32(
            joint_names_expr=["waist_.*"],
            armature=2.0 * unitree_actuators.UnitreeActuatorCfg_N6010B_32().armature,
        ),
        "N6014B-12.6": unitree_actuators.UnitreeActuatorCfg_N6014B_12p6(
            joint_names_expr=[".*_shoulder_yaw.*", ".*_elbow_.*", ".*_wrist_roll_.*"],
        ),
        "N6014B-12.6-parallel": unitree_actuators.UnitreeActuatorCfg_N6014B_12p6(
            joint_names_expr=[".*_ankle_.*"],
            armature=2.0 * unitree_actuators.UnitreeActuatorCfg_N6014B_12p6().armature,
        ),
    },
    joint_sdk_names=[
        "left_hip_pitch_joint",
